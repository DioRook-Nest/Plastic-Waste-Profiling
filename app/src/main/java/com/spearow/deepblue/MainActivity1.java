...
public class MainActivity1 extends AppCompatActivity {
    ...
    private class AsyncRetrieve extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(MainActivity1.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://192.168.100.11/DeepBlue/test.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("Success! This message is from PHP")) {
                ...
                Toast.makeText(MainActivity1.this, result.toString(), Toast.LENGTH_LONG).show();
            }
