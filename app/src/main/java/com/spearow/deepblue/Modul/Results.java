...
public class Results {
    ...
    {
        return "ClassPojo [types = "+types+", icon = "+icon+", rating = "+rating+", photos = "+photos+", reference = "+reference+", user_ratings_total = "+user_ratings_total+", scope = "+scope+", name = "+name+", geometry = "+geometry+", vicinity = "+vicinity+", id = "+id+", plus_code = "+plus_code+", place_id = "+place_id+"]";
    }
}
